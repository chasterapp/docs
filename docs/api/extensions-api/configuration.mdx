...
Tags help users discover your extension in the extensions marketplace. You can select multiple tags from different categories to describe your extension's functionality and characteristics.

Tags are organized into the following categories:

- **Function:** Describes what your extension does (e.g., Games, Tasks & Challenges, Randomness, Unlocking, Penalties, Verification, Automation, AI)
- **Interaction:** Describes how users interact with the extension (e.g., Solo, With Others, Keyholder, Public)
- **Style:** Describes the gameplay style (e.g., Luck-Based, Skill-Based, Puzzle, Gambling)
- **Experience:** Describes the target audience and difficulty (e.g., Beginner Friendly, Advanced, High Risk)

Selecting appropriate tags improves the discoverability of your extension and helps users find extensions that match their preferences.
