...
To check if a user is currently in the pillory and retrieve information about active pillory votes, see the [Pillory Status API](/api/extensions-api/interact-with-extensions/pillory).
