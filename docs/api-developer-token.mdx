---
id: api-developer-token
title: Developer token
sidebar_label: Developer token
slug: /api-developer-token
---
...
:::info
If you are going to create an application that can be used by other Chaster users besides yourself, you can use [OAuth 2 authentication](/api-oauth-2), which will allow other users to log into their account and use your application.
:::
