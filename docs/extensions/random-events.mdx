...
:::danger[Known Issue]
The event intervals described below may not match actual behavior. Community testing has shown that events tend to occur approximately 90 minutes later than the documented intervals suggest. For example, on the "Easy" difficulty, the observed average interval is around 2.5 hours instead of the documented 1 hour. This affects all difficulty levels, though the impact is less noticeable on harder difficulties where intervals are longer.
:::
