...
{/* SCREENSHOT: permissions-consent-join.png | Join screen of a shared lock, wearer side, Trusted keyholder preset, showing the consent sentence and the differences from Standard */}
...
{/* SCREENSHOT: permissions-change-review.png | Change permissions page, review step, showing the "Applies immediately" and "Sent for approval" buckets */}

{/* SCREENSHOT: permissions-pending-proposal.png | Pending proposal card on the lock settings page with the Accept, Reject, Counter-offer buttons */}
