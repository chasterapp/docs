...
When enabled, your lock will be in test mode. This ensures that it doesn't affect your statistics or archivements. This option is useful to thoroughly test the functionality of your a lock without any impacy on your overall progress.

In case you forgot to enable this option during the lock creation process, you can still do it after. Once the lock is archived, you can set it as a test lock by accessing your list of archived locks.
