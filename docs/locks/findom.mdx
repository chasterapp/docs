...
A Findom, short for Financial Domination, is a consensual power exchange dynamic within the BDSM community. In a Findom relationship, one person, known as the Findom or Financial Dominant, gains control over the financial aspect of another person. Findoms generally receive financial tributes, gifts, or payments from their submissives as an expression of power exchange.

:::note
All Findom activities should be based on informed consent and respect for boundaries.
:::

On Chaster, a person is considered Findom when they request any form of gift or payment in association with their activity as a keyholder, either on the Chaster app or on the Discord server.
...
- **Chaster Plus Subscription**: Findoms must have an active Chaster Plus subscription to engage in findom activities on the platform. The subscription provides access to exclusive features and benefits specifically designed for findoms.

- **Setting the "Findom" Tag**: Findoms are required to set the "Findom" tag on their profile. This can be done in the profile settings. The tag helps distinguish findoms from other users and provides visibility within the community.
...
Adhering to these findom rules ensures a positive and consensual experience for both findoms and users on Chaster. Failure to comply with these rules may result in account suspension.
